...
import Procedimientos.Empleado;
 ...
 */
public class EmpleadoP extends javax.swing.JFrame {

    /**
     * Creates new form EmpleadoP
     */
...
//                                
    ...
    private void initComponents() {
        ...
        cmbComsion = new javax.swing.JComboBox();
        ...
        cmbComsion.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        cmbComsion.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "<Sin Comisión>", "1%", "2%", "3%" }));
        cmbComsion.setToolTipText("Seleccione Proveedor");
        cmbComsion.setEnabled(false);
        cmbComsion.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                cmbComsionKeyTyped(evt);
            }
        });

        cmbArea.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        cmbArea.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "<Seleccione>", "Ventas", "Caja" }));
        cmbArea.setToolTipText("Seleccione Proveedor");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addComponent(cmbComsion, javax.swing.GroupLayout.PREFERRED_SIZE, 301, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addComponent(jLabel10, javax.swing.GroupLayout.PREFERRED_SIZE, 301, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
                .addComponent(cmbArea, javax.swing.GroupLayout.PREFERRED_SIZE, 301, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cmbComsion, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        cmbbusc.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "No.", "Nombres", "Apellidos", "No. Cédula", "Área", "Estado" }));
    ...
    public void Guardar (){
        ...
        String Nombres, Apellidos, FotoP, Cedula, Correo, Direccion, Telefono, Area;
        int SelectCombo = cmbArea.getSelectedIndex();
...
//            return;
    ...
    resultado = Conexion.consulta("Select [ID_Empleado] from [dbo].[Empleado] where [ID_Empleado] != "+ID_Empleado+" and "
...
if(IDC != 0){
    JOptionPane.showMessageDialog(this, "Número de Cédula "+Cedula+" del Empleado ya Existe en el Registro", "No. Cédula ya Registrado", JOptionPane.ERROR_MESSAGE);
    return;
}
       ...
       if(SelectCombo==0){
            ...
            JOptionPane.showMessageDialog(this,"Seleccione El Área","Seleccione",JOptionPane.ERROR_MESSAGE);
            return;
        }

       int SelecCom = cmbComsion.getSelectedIndex();
       
       double Comision = SelecCom;
...
//           }
       ...
       if("".equals(FotoP)){
           ...
           FotoP = F.getAbsolutePath()+"\\Farmacia\\Default\\Empleado.jpg";
       }
            ...
            if(Modify==true){
                ...
                Empleado.Actualizar_Empleado(ID, Nombres, Apellidos, Telefono, Cedula, 
                        Correo, Direccion, Comision, FotoP, Area);
//                
//                if(!"".equals(FotoP)){
//                Empleado.Agregar_Imagen(ID, FotoP);
//                }
//                
                ActualizarTabla();
                CleanAll();
                ...
                Empleado.Agregar_Empleado(Nombres, Apellidos, Telefono, Cedula, 
                        Correo, Direccion, Comision, FotoP, Area);
                ActualizarTabla();
                CleanAll();
                DisableAll();
   ...
   public void ActualizarTabla(){
       ...
       Tabla.setModel(model);
        ...
        resultado = Conexion.consulta("Select * from [dbo].[EmpleadoV]");
       ...
       {     
              ...
              Datos [9]= String.valueOf(resultado.getDouble(9));
              java.util.Date FechaI = resultado.getDate(10);
              DateFormat df4 = DateFormat.getDateInstance(DateFormat.FULL);
              String Fecha = df4.format(FechaI);
              Datos [10]= Fecha;
              String Empleado = resultado.getString(11).trim()+" "+resultado.getString(12).trim();
              Datos [11]= Empleado;
       ...
       Titulo();
        ...
        switch(index){
            ...
            try{
                ...
                resultado = Conexion.consulta("Select * from [dbo].[EmpleadoV] where [ID_Empleado] like '%"+Buscar+"%'");
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from [dbo].[EmpleadoV] where [Nombres_Empleado] like '%"+Buscar+"%'");
...
//       Tabla.getColumnModel().getColumn(2).setCellRenderer(getRenderer());
//        }
//       Tabla.repaint();
          ...
          case 3:
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from [dbo].[EmpleadoV] where [Apellidos_Empleado] like '%"+Buscar+"%'");
           ...
           case 4:
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from [dbo].[EmpleadoV] where [Cedula_Empleado] like '%"+Buscar+"%'");
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from [dbo].[EmpleadoV] where [Area] like '%"+Buscar+"%'");
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from [dbo].[EmpleadoV] where [Estado_Empleado] like '%"+Buscar+"%'");
...
// TODO add your handling code here:
   ...
   resultado = Conexion.consulta("Select Fotografia_Empleado from Empleado where ID_Empleado = "+ID);
     ...
     if (resultado.next()){
            ...
            jLblFoto1.setIcon(newIcon);
                 ...
                 {
                         JOptionPane.showMessageDialog(null, "El Empleado No Posee Fotografía","Error",JOptionPane.ERROR_MESSAGE);
   ...
   public void Activar(){
       ...
       boolean Flag;
             ...
             Opcion= JOptionPane.showConfirmDialog(this, "Está Seguro Que Desea Activar Empleado(es) ?", "Confirmación", JOptionPane.YES_NO_OPTION);
        ...
        for(int i=0; i<Tabla.getRowCount();i++){
         ...
         if(Flag == true){
               ...
               Empleado.Activar_Empleado(ID);
         }
               
            }
         JOptionPane.showMessageDialog(this, "Empleado(s) Activado(s) Con Éxito", "Activado(s) Con Éxito", JOptionPane.INFORMATION_MESSAGE);
     ...
     public void Desactivar(){
       ...
       boolean Flag;
             ...
             Opcion= JOptionPane.showConfirmDialog(this, "Está Seguro Que Desea Desactivar Empleado(es) ?", "Confirmación", JOptionPane.YES_NO_OPTION);
        ...
        for(int i=0; i<Tabla.getRowCount();i++){
         ...
         if(Flag == true){
               ...
               Empleado.Desactivar_Empleado(ID);
         }
               
            }
         JOptionPane.showMessageDialog(this, "Empleado(s) Desactivado(s) Con Éxito", "Activado(s) Con Éxito", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void Modificar(){
        ...
        int ID;
        String Nombres, Apellidos, Cedula, Direccion, Correo,
                Area, Telefono;
        Double Comision;
        ...
        if (fila > -1){
            ...
            Cedula=((String)this.Tabla.getModel().getValueAt(fila, 4));
            Telefono=((String)this.Tabla.getModel().getValueAt(fila, 5));
            Area=((String)this.Tabla.getModel().getValueAt(fila, 6));
            Correo=((String)this.Tabla.getModel().getValueAt(fila, 7));
            Direccion=((String)this.Tabla.getModel().getValueAt(fila, 8));
            Comision= Double.parseDouble(this.Tabla.getModel().getValueAt(fila, 9).toString());

            CleanAll();
            EnableAll();
            
            int Pos = Comision.intValue();
        ...
        cmbComsion.setSelectedIndex(Pos);
        ...
        ActualizarFoto();
            ...
            JOptionPane.showMessageDialog(this, "Seleccione Un Empleado a Modificar", "Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void btnprintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnprintActionPerformed
        ...
        File miDir = new File ("");
        String reporte = miDir.getAbsolutePath()+"\\src\\Reportes\\Empleado.jasper";
...
//                Logger.getLogger(ProveedorP.class.getName()).log(Level.SEVERE, null, ex);
        ...
        view.setTitle("Empleados - Sistema de Inventario y Facturación RJ");
...
// TODO add your handling code here:
    ...
    public void Titulo(){
         Object [] Titulo = {"","No.", "Nombres", "Apellidos",
            "No. Cédula", "Teléfono", "Área", "Correo", "Dirección", "Comisión",
...
if(!Character.isLetter(a)&&!Character.isISOControl(a)&&a!=KeyEvent.VK_SPACE){
...
char a = evt.getKeyChar();
 ...
 // TODO add your handling code here:
    ...
    private void cmbComsionKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmbComsionKeyTyped
char a = evt.getKeyChar();
...
// TODO add your handling code here:
    }//GEN-LAST:event_cmbComsionKeyTyped
 ...
 if(a == KeyEvent.VK_ENTER){
    ...
    public void ActivarDesactivar(){
        ...
        if (fila > -1){
            ...
            Estado = ((String)this.Tabla.getModel().getValueAt(fila,12));

           
            
            if("Activo".equalsIgnoreCase(Estado)){
                
                v= JOptionPane.showConfirmDialog(this, "Está Seguro Que Desea Desactivar al Empleado "+Nombre.trim()+" "+Apellido.trim()+"?", "Confirmación", JOptionPane.YES_NO_OPTION);
            }
            if("Inactivo".equalsIgnoreCase(Estado)){
             
                v= JOptionPane.showConfirmDialog(this, "Está Seguro Que Desea Activar al Empleado "+Nombre.trim()+" "+Apellido.trim()+"?", "Confirmación", JOptionPane.YES_NO_OPTION);
            }

            if(v==JOptionPane.YES_OPTION){

                
                Empleado.Activar_Desactivar_Empleado(ID);
            ...
            JOptionPane.showMessageDialog(this, "Seleccione Un Empleado a Activar/Desactivar", "Error", JOptionPane.ERROR_MESSAGE);
...
// TODO add your handling code here:
    ...
    private void cmbAreaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmbAreaKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbAreaKeyTyped
     ...
     public class FormatoTabla extends DefaultTableCellRenderer
{
 ...
 (JTable table, Object value, boolean selected, boolean focused, int row, int column)
 {
  ...
  if(String.valueOf(table.getValueAt(row,12)).equalsIgnoreCase("Inactivo"))  {
  ...
  {  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmpleadoP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
    ...
    private javax.swing.JComboBox cmbComsion;
