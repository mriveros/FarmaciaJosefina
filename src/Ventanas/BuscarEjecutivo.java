 ...
 * @author Reymundo
 */
public class BuscarEjecutivo extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public BuscarEjecutivo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addComponent(txtbusc, javax.swing.GroupLayout.DEFAULT_SIZE, 932, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        setSize(new java.awt.Dimension(1287, 722));
   ...
   resultado = Conexion.consulta("Select Fotografia_Ejecutivo from Ejecutivo where ID_Ejecutivo = "+ID);
    ...
    public void Seleccionar(){
         ...
         int fila = Tabla.getSelectedRow();
           ...
           if(Compra!=null){
           Compra.SetEjecutivo(Nombre.trim()+" "+Apellido.trim());
           this.dispose();
               }
           }
            else{     
              JOptionPane.showMessageDialog(this, "Seleccione Un Ejecutivo Activo", "Seleccione", JOptionPane.ERROR_MESSAGE);
           }
           
           }
           else{
             JOptionPane.showMessageDialog(this, "Seleccione Un Ejecutivo", "Seleccione", JOptionPane.ERROR_MESSAGE);
           }
    ...
    public void setCompra(ComprasP Compra) {
      ...
      public void ActualizarTabla(){
       ...
       Tabla.setModel(model);
        ...
        resultado = Conexion.consulta("Select * from [dbo].[Buscar_EjecutivoV] where ID_Proveedor = "+ID_Proveedor);
       ...
       Titulo();
        ...
        switch(index){
            ...
            try{
                ...
                resultado = Conexion.consulta("Select * from [dbo].[Buscar_EjecutivoV] where [ID_Ejecutivo] like '%"+Buscar+"%'"
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from [dbo].[Buscar_EjecutivoV] where [Nombres_Ejecutivo] like '%"+Buscar+"%'"
                        + " and ID_Proveedor = "+ID_Proveedor);
...
//       Tabla.repaint();
          ...
          case 3:
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from [dbo].[Buscar_EjecutivoV] where [Apellidos_Ejecutivo] like '%"+Buscar+"%'"
                        + " and ID_Proveedor = "+ID_Proveedor);
           ...
           case 4:
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from [dbo].[Buscar_EjecutivoV] where [Cedula_Ejecutivo] like '%"+Buscar+"%'"
                        + " and ID_Proveedor = "+ID_Proveedor);
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from [dbo].[Buscar_EjecutivoV] where [Sexo_Ejecutivo] like '%"+Buscar+"%'"
                       + " and ID_Proveedor = "+ID_Proveedor);
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from [dbo].[Buscar_EjecutivoV] where [Nombre_Proveedor] like '%"+Buscar+"%'"
                        + " and ID_Proveedor = "+ID_Proveedor);
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from [dbo].[Buscar_EjecutivoV] where [Estado_Ejecutivo] like '%"+Buscar+"%'"
                        + " and ID_Proveedor = "+ID_Proveedor);
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarEjecutivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BuscarEjecutivo dialog = new BuscarEjecutivo(new javax.swing.JFrame(), true);
