...
import Procedimientos.CuentaxCobrar;
 ...
 */
public class PedidosP extends javax.swing.JFrame {

    /**
     * Creates new form ProductoP
     */
    public PedidosP() throws UnknownHostException {
...
//                                
    ...
    private void initComponents() {
        ...
        btnProcesar.setText("Procesar Orden");
    ...
    public void BuscarCodigoBarra() {
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                Stock_Min = resultado.getInt(5);
                UnidsXCaja = resultado.getInt(6);
            }
        } catch (SQLException ex) {
        }
...
//         return;
    ...
    public void Titulo() {
        ...
        String Titu[] = {"No", "Empleado", "Cliente", "Fecha Venta", 
            //"Unidads Totales", "Moneda", "Tipo Cambio", "Sub-Total",
            "Descuento"
                //, "I.V.A", "Total", "Modo", "Estado"
        };
...
//     ModeloAutoCompletar modelo1 = new ModeloVentasName();
    public void ActualizarTabla() {
        ...
        try {
            ...
            resultado = Conexion.consulta("Select * from VentaV");
            ...
            while (resultado.next()) {
                ...
                Datos[3] = String.valueOf(resultado.getDate(5));
    ...
    public boolean Procesar() throws IOException {
    
    boolean conectado = new ClienteServer().ProbarConexion();
    
    if(conectado==false){
        JOptionPane.showMessageDialog(this, "Cajero no conectado, Verifique su conexión"
                ,"No conectado", JOptionPane.ERROR_MESSAGE);
        return false;
    }
        ...
        SubTotal = txtSubTotal.getText().trim();
           ...
           try{
             ...
             ID_P = Orden.Agregar_Orden(MenuPrincipal.ID_Usuario, NombreCliente, ID_Cliente, Fecha , Desc, ID_TipoCambio, ModoFactura, "Pendiente");
            ...
            for (int j = 0; j < FilasProductos; j++) {
                ...
                if("Presentación".equals(Individual)){
                    ...
                    System.out.println("UnidsV: "+UnidsV);
                 
                }

             
             Orden.Agregar_DetalleOrden(ID_P, ID_Prod, UnidsV, Individual, PrecioV);
             
            }

           for (int i = 0; i < FilasProductos; i++) {
                int ID_ProductoV;
                String Individ = "Individual";
                
                int UnidadesV = Integer.parseInt(this.JTableLista.getModel().getValueAt(i, 1).toString());
                ID_ProductoV = Integer.parseInt(this.JTableLista.getModel().getValueAt(i, 5).toString());
                Individ = this.JTableLista.getModel().getValueAt(i, 6).toString();
                
                   if("Presentación".equals(Individ)){
                    int UnidCaja = 0;
                    try{
                     resultado = Conexion.consulta("Select [UnidsXCaja] from ProductoV where ID_Producto = "+ID_ProductoV);
                    ...
                    UnidadesV = UnidadesV*UnidCaja;
                 
                }
            Orden.DisminuirInventario(ID_ProductoV, UnidadesV);     
            }
           if("Crédito".equals(TipoPago)){
           CuentaxCobrar.Agregar_Cuenta(ID_Cliente,ID_P,jFecha.getDate(),Total1);
           }
            Orden.Agregar_OrdenFactura(ID_P, SubTotal1, IVA1, Descuento, Total1);
          ...
          /* FacturacionPJ fc = new FacturacionPJ();
            ...
            */
            ...
            for (int k = 0; k < c1; k++) {
                ...
                int Unidss = Integer.parseInt(Unids1);
                double PVV = Double.parseDouble(PV1);
                double Totall = Double.parseDouble(TotalF1);
                
                Orden.Agregar_DetalleFactura(ID_P,NombreProducto1,Unidss,PVV,Totall,Indiv);
...
/*
            ...
            */
            ...
            new ClienteServer().IniciarConexion();
            /*
            File F = new File("");
    ...
    public class FormatoTabla extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean selected, boolean focused, int row, int column) {
            ...
            if (String.valueOf(table.getValueAt(row, 0)).equalsIgnoreCase("true")) {
...
public void run(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PedidosP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
