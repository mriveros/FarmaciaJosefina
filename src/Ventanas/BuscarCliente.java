...
// TODO add your handling code here:
   ...
   // TODO add your handling code here:
    ...
    private PedidosP Pedido;
    private ProformaP Proforma;

    public void setPedido(PedidosP Pedido) {
        this.Pedido = Pedido;
    }
   ...
   public void Seleccionar(){
     ...
     int fila = Tabla.getSelectedRow();
           ...
           ID_C=Integer.parseInt(this.Tabla.getModel().getValueAt(fila, 1).toString());
           Nombre=((String)this.Tabla.getModel().getValueAt(fila, 3));
           Apellido = ((String)this.Tabla.getModel().getValueAt(fila, 4));
           Descuento = Double.parseDouble(this.Tabla.getModel().getValueAt(fila, 11).toString());
           Estado = ((String)this.Tabla.getModel().getValueAt(fila, 14));
           
           if("Activo".equals(Estado)){
               
           if(Pedido!=null){
           String NombreC = Nombre.trim()+" "+Apellido.trim();
           int Des = Descuento.intValue();
           Pedido.SetCliente(ID_C, NombreC, Des);
           this.dispose();
               }
           if(Proforma!=null){
           String NombreC = Nombre.trim()+" "+Apellido.trim();
           int Des = Descuento.intValue();
           Proforma.SetCliente(ID_C, NombreC, Des);
           this.dispose();
               }
           }
            else{     
              JOptionPane.showMessageDialog(this, "Seleccione Un Cliente Activo", "Seleccione", JOptionPane.ERROR_MESSAGE);
           }
           
           }
           else{
             JOptionPane.showMessageDialog(this, "Seleccione Un Cliente", "Seleccione", JOptionPane.ERROR_MESSAGE);
           }
...
//				
//PanelEffect2.setEffect(new EntryBoucing(1000));
//PanelEffect2.startEffect();
