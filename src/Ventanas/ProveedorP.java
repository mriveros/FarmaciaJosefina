...
import Procedimientos.Proveedor;
 ...
 */
public class ProveedorP extends javax.swing.JFrame {

    /**
     * Creates new form ProveedorP
     */
...
//                                
    ...
    private void initComponents() {
        ...
        cmbtipo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "<Seleccione>", "Laboratorio", "Distribuidora" }));
        cmbtipo.setToolTipText("Seleccione Proveedor");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addComponent(cmbtipo, javax.swing.GroupLayout.PREFERRED_SIZE, 301, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
            .addGroup(jPanel3Layout.createSequentialGroup()
   ...
   // private int ID_Proveedor;
    ...
    public void Guardar (){
        ...
        String Nombre, TipoProveedor, NoRUC, FotoP, Correo, Direccion, Telefono;
      
        Nombre = txtNombre.getText().trim();
        NoRUC = txtRuc.getText().trim();
        TipoProveedor = (String) cmbtipo.getSelectedItem();
     ...
     return;  
        ...
        if("<Seleccione>".equals(TipoProveedor))  {
            JOptionPane.showMessageDialog(this,"Seleccione el Tipo de Proveedor","Seleccione",JOptionPane.ERROR_MESSAGE);
            return;
           }
...
//            return;
    ...
    resultado = Conexion.consulta("Select [ID_Proveedor] from [dbo].[Proveedor] where [ID_Proveedor] != "+ID_Proveedor+" and "
            + " [No_Ruc] = '"+NoRUC+"'");
...
if(IDC1 != 0){
    JOptionPane.showMessageDialog(this, "Nombre del Proveedor "+Nombre+" ya Existe en el Registro", "Nombre ya Registrado", JOptionPane.ERROR_MESSAGE);
    return;
}
...
//           }
  ...
  if("".equals(FotoP)){
           File F = new File("");          
           FotoP = F.getAbsolutePath()+"\\Farmacia\\Default\\Proveedor.png";
       }
            ...
            if(Modify==true){
                ...
                Proveedor.Actualizar_Proveedor(ID, Nombre, NoRUC, Telefono, TipoProveedor, Correo, Direccion, FotoP);
                ...
                Proveedor.Agregar_Proveedor(Nombre, NoRUC, Telefono, TipoProveedor, Correo, Direccion, FotoP);
                ActualizarTabla();
                CleanAll();
                DisableAll();
...
// TODO add your handling code here:
   ...
   public void Activar(){
       ...
       boolean Flag;
             ...
             Opcion= JOptionPane.showConfirmDialog(this, "Está Seguro Que Desea Activar Proveedor(es) ?", "Confirmación", JOptionPane.YES_NO_OPTION);
        ...
        for(int i=0; i<Tabla.getRowCount();i++){
         ...
         if(Flag == true){
               ...
               Proveedor.Activar_Proveedor(ID);
         }
               
            }
         JOptionPane.showMessageDialog(this, "Proveedor(s) Activado(s) Con Éxito", "Activado(s) Con Éxito", JOptionPane.INFORMATION_MESSAGE);
     ...
     public void Desactivar(){
       ...
       boolean Flag;
             ...
             Opcion= JOptionPane.showConfirmDialog(this, "Está Seguro Que Desea Desactivar Proveedor(es) ?", "Confirmación", JOptionPane.YES_NO_OPTION);
        ...
        for(int i=0; i<Tabla.getRowCount();i++){
         ...
         if(Flag == true){
               ...
               Proveedor.Desactivar_Proveedor(ID);
         }
               
            }
         JOptionPane.showMessageDialog(this, "Proveedor(s) Desactivado(s) Con Éxito", "Activado(s) Con Éxito", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void Modificar(){
        ...
        int ID;
        String Nombre, Tipo, NoRUC, Direccion, Correo, Telefono;
        
        if (fila > -1){

            ID= Integer.parseInt(this.Tabla.getModel().getValueAt(fila, 1).toString());
            Tipo=((String)this.Tabla.getModel().getValueAt(fila, 2));
            Nombre=((String)this.Tabla.getModel().getValueAt(fila, 3));
            NoRUC=((String)this.Tabla.getModel().getValueAt(fila, 4));
            Telefono=((String)this.Tabla.getModel().getValueAt(fila, 5));
            Direccion=((String)this.Tabla.getModel().getValueAt(fila, 6));
        ...
        ActualizarFoto();
            ...
            JOptionPane.showMessageDialog(this, "Seleccione Un Proveedor a Modificar", "Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void btnprintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnprintActionPerformed
        ...
        File miDir = new File ("");
        String reporte = miDir.getAbsolutePath()+"\\src\\Reportes\\Proveedor.jasper";
...
//                Logger.getLogger(ProveedorP.class.getName()).log(Level.SEVERE, null, ex);
        ...
        view.setTitle("Proveedores - Sistema de Inventario y Facturación RJ");
...
if(ID != 0){
    ...
    lblalerta.setText("No. RUC no disponible");
}
else{
    ...
    public void ActivarDesactivar(){
        ...
        if (fila > -1){
            ...
            if("Activo".equalsIgnoreCase(Estado)){
                ...
                v= JOptionPane.showConfirmDialog(this, "Está Seguro Que Desea Desactivar al Proveedor "+Nombre.trim()+"?", "Confirmación", JOptionPane.YES_NO_OPTION);
            }
            if("Inactivo".equalsIgnoreCase(Estado)){
             
                v= JOptionPane.showConfirmDialog(this, "Está Seguro Que Desea Activar al Proveedor "+Nombre.trim()+"?", "Confirmación", JOptionPane.YES_NO_OPTION);
            }

            if(v==JOptionPane.YES_OPTION){

                
                Proveedor.Activar_Desactivar_Proveedor(ID);
            ...
            JOptionPane.showMessageDialog(this, "Seleccione Un Proveedor a Activar/Desactivar", "Error", JOptionPane.ERROR_MESSAGE);
...
if(ID != 0){
    ...
    lblalerta.setText("Nombre del proveedor no disponible");
}
else{
    ...
    private void cmbtipoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmbtipoKeyTyped
char a = evt.getKeyChar();
...
if(a == KeyEvent.VK_ENTER){
    ...
    }//GEN-LAST:event_cmbtipoKeyTyped
  ...
  {  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProveedorP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new ProveedorP().setVisible(true);               
            }
        });
    }
