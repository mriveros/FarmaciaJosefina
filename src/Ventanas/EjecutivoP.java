...
import Procedimientos.Ejecutivo;
 ...
 */
public class EjecutivoP extends javax.swing.JFrame {

    /**
     * Creates new form EjecutivoP
     */
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addComponent(cmbprov, javax.swing.GroupLayout.PREFERRED_SIZE, 301, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cmbprov, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        btntabla.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Buscar_1.png"))); // NOI18N
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGap(2, 2, 2)
                .addComponent(btntabla, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(68, 68, 68)
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                .addGap(364, 364, 364)
                                .addComponent(btntabla, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        cmbbusc.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "No.", "Nombres", "Apellidos", "No. Cédula", "Sexo", "Proveedor", "Estado" }));
...
//            return;
    ...
    resultado = Conexion.consulta("Select [ID_Ejecutivo] from [dbo].[Ejecutivo] where [ID_Ejecutivo] != "+ID_Ejecutivo+" and "
            + "[Cedula_Ejecutivo] = '"+Cedula+"'");
...
if(IDC != 0){
    JOptionPane.showMessageDialog(this, "Número de Cédula "+Cedula+" del Ejecutivo ya Existe en el Registro", "No. Cédula ya Registrado", JOptionPane.ERROR_MESSAGE);
    return;
}
...
//           }
       ...
       if("".equals(FotoP)){
           ...
           FotoP = F.getAbsolutePath()+"\\Farmacia\\Default\\Ejecutivo.jpg";
       }
  ...
  int ID_Proveedor = Proveedores[SelectCombo];
            ...
            if(Modify==true){
                ...
                Ejecutivo.Actualizar_Ejecutivo(ID, Nombres, Apellidos, Telefono, Cedula, Correo, Direccion, Sexo,
                        ID_Proveedor, FotoP);
//                
//                if(!"".equals(FotoP)){
//                Ejecutivo.Agregar_Imagen(ID, FotoP);
//                }
//                
                ActualizarTabla();
                CleanAll();
                ...
                Ejecutivo.Agregar_Ejecutivo(Nombres, Apellidos, Telefono, Cedula, Correo, Direccion, Sexo, 
                        ID_Proveedor, FotoP);
                ActualizarTabla();
                CleanAll();
                DisableAll();
   ...
   public void ActualizarTabla(){
       ...
       Tabla.setModel(model);
        ...
        resultado = Conexion.consulta("Select * from [dbo].[EjecutivoV]");
       ...
       Titulo();
        ...
        switch(index){
            ...
            try{
                ...
                resultado = Conexion.consulta("Select * from [dbo].[EjecutivoV] where [ID_Ejecutivo] like '%"+Buscar+"%'");
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from [dbo].[EjecutivoV] where [Nombres_Ejecutivo] like '%"+Buscar+"%'");
...
//       Tabla.repaint();
          ...
          case 3:
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from [dbo].[EjecutivoV] where [Apellidos_Ejecutivo] like '%"+Buscar+"%'");
           ...
           case 4:
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from [dbo].[EjecutivoV] where [Cedula_Ejecutivo] like '%"+Buscar+"%'");
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from [dbo].[EjecutivoV] where [Sexo_Ejecutivo] like '%"+Buscar+"%'");
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from [dbo].[EjecutivoV] where [Nombre_Proveedor] like '%"+Buscar+"%'");
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from [dbo].[EjecutivoV] where [Estado_Ejecutivo] like '%"+Buscar+"%'");
...
// TODO add your handling code here:
   ...
   resultado = Conexion.consulta("Select Fotografia_Ejecutivo from Ejecutivo where ID_Ejecutivo = "+ID);
     ...
     if (resultado.next()){
            ...
            jLblFoto1.setIcon(newIcon);
                 ...
                 {
                         JOptionPane.showMessageDialog(null, "El Ejecutivo No Posee Fotografía","Error",JOptionPane.ERROR_MESSAGE);
   ...
   public void Activar(){
       ...
       boolean Flag;
             ...
             Opcion= JOptionPane.showConfirmDialog(this, "Está Seguro Que Desea Activar Ejecutivo(es) ?", "Confirmación", JOptionPane.YES_NO_OPTION);
        ...
        for(int i=0; i<Tabla.getRowCount();i++){
         ...
         if(Flag == true){
               ...
               Ejecutivo.Activar_Ejecutivo(ID);
         }
               
            }
         JOptionPane.showMessageDialog(this, "Ejecutivo(s) Activado(s) Con Éxito", "Activado(s) Con Éxito", JOptionPane.INFORMATION_MESSAGE);
     ...
     public void Desactivar(){
       ...
       boolean Flag;
             ...
             Opcion= JOptionPane.showConfirmDialog(this, "Está Seguro Que Desea Desactivar Ejecutivo(es) ?", "Confirmación", JOptionPane.YES_NO_OPTION);
        ...
        for(int i=0; i<Tabla.getRowCount();i++){
         ...
         if(Flag == true){
               ...
               Ejecutivo.Desactivar_Ejecutivo(ID);
         }
               
            }
         JOptionPane.showMessageDialog(this, "Ejecutivo(s) Desactivado(s) Con Éxito", "Activado(s) Con Éxito", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void Modificar(){
        ...
        int ID;
        String Nombres, Apellidos, Cedula,  Proveedor, Direccion, Correo,
                Sexo, Telefono;
        ...
        if (fila > -1){
            ...
            Sexo=((String)this.Tabla.getModel().getValueAt(fila, 5));
            Telefono=((String)this.Tabla.getModel().getValueAt(fila, 6));
            Correo=((String)this.Tabla.getModel().getValueAt(fila, 7));
            Direccion=((String)this.Tabla.getModel().getValueAt(fila, 8));
            Proveedor= ((String)this.Tabla.getModel().getValueAt(fila, 9));
        ...
        ActualizarFoto();
            ...
            JOptionPane.showMessageDialog(this, "Seleccione Un Ejecutivo a Modificar", "Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void btnprintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnprintActionPerformed
        ...
        File miDir = new File ("");
        String reporte = miDir.getAbsolutePath()+"\\src\\Reportes\\Ejecutivo.jasper";
...
//                Logger.getLogger(ProveedorP.class.getName()).log(Level.SEVERE, null, ex);
        ...
        view.setTitle("Ejecutivos - Sistema de Inventario y Facturación RJ");
...
// TODO add your handling code here:
    ...
    public void Titulo(){
         Object [] Titulo = {"","No.", "Nombres", "Apellidos",
            "No. Cédula", "Sexo", "Teléfono", "Correo", "Dirección", "Proveedor", 
    ...
    public void ActivarDesactivar(){
        ...
        if (fila > -1){
            ...
            if("Activo".equalsIgnoreCase(Estado)){
                ...
                v= JOptionPane.showConfirmDialog(this, "Está Seguro Que Desea Desactivar al Ejecutivo "+Nombre.trim()+" "+Apellido.trim()+"?", "Confirmación", JOptionPane.YES_NO_OPTION);
            }
            if("Inactivo".equalsIgnoreCase(Estado)){
             
                v= JOptionPane.showConfirmDialog(this, "Está Seguro Que Desea Activar al Ejecutivo "+Nombre.trim()+" "+Apellido.trim()+"?", "Confirmación", JOptionPane.YES_NO_OPTION);
            }

            if(v==JOptionPane.YES_OPTION){

                
                Ejecutivo.Activar_Desactivar_Ejecutivo(ID);
            ...
            JOptionPane.showMessageDialog(this, "Seleccione Un Ejecutivo a Activar/Desactivar", "Error", JOptionPane.ERROR_MESSAGE);
  ...
  {  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EjecutivoP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new EjecutivoP().setVisible(true);               
            }
        });
    }
