...
public class BuscarLaboratorio extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public BuscarLaboratorio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addComponent(txtbusc, javax.swing.GroupLayout.DEFAULT_SIZE, 905, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        setSize(new java.awt.Dimension(1260, 722));
    ...
    public void Seleccionar(){
         ...
         int fila = Tabla.getSelectedRow();
           ...
           if("Activo".equals(Estado)){
               ...
               if(Producto!=null){
           Producto.SetLaboratorio(Nombre.trim());
           this.dispose();
               }
           }
            else{     
       ...
       Titulo();
        ...
        switch(index){
            ...
            try{
                ...
                resultado = Conexion.consulta("Select * from [dbo].[LaboratorioV] where [ID_Proveedor] like '%"+Buscar+"%'");
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from [dbo].[LaboratorioV] where [Tipo_Proveedor] like '%"+Buscar+"%'");
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from [dbo].[LaboratorioV] where [Nombre_Proveedor] like '%"+Buscar+"%'");
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from [dbo].[LaboratorioV] where [No_RUC] like '%"+Buscar+"%'");
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from [dbo].[LaboratorioV] where [Estado_Proveedor] like '%"+Buscar+"%'");
    ...
    private void btncancel3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncancel3ActionPerformed
      ...
      public void ActualizarTabla(){
       ...
       Tabla.setModel(model);
        ...
        resultado = Conexion.consulta("Select * from [dbo].[LaboratorioV]");
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BuscarLaboratorio dialog = new BuscarLaboratorio(new javax.swing.JFrame(), true);
