...
public final class WebCam extends  javax.swing.JFrame implements MouseListener {
    ...
    public WebCam(int Device) {
     ...
     // this.setUndecorated(true);
        ...
        try{
        this.setIconImage (new ImageIcon(getClass().getResource("WebCam.png")).getImage());
...
//      WC.setDispositivos(Dispositivos);
    ...
    public void setHome(String Ruta){
        
        File F = new File("");
        
        String RutaFarmacia = F.getAbsolutePath()+"/Farmacia/Capturas/";
        String RutaHome = RutaFarmacia.concat(Ruta);
 
        Home = new File(RutaHome);
...
//    }
  ...
  public void setBC(BuscarCliente BC) {
    ...
    private void initComponents() {
        ...
        btnCapture1.setBorderPainted(false);
...
if(chAutoRostro.isSelected()){
    ...
    public void Cerrar(){
      ...
      this.Representante.setVisible(true);
      }
      if(Producto!=null){
      this.Producto.setVisible(true);
      }
      if(Proveedor!= null ){
      this.Proveedor.setVisible(true);
      }
      if(Empleado!= null ){
      ...
      if(e.getClickCount()==2){
        ...
        for(int i=0;i<Foto.length;i++){
            if(E.equals(Foto[i])){
                ...
                VIF.setCliente(Cliente);
                VIF.setBC(BC);
                VIF.setRepresentante(Representante);
                VIF.setClienteJ(ClienteJ);
                VIF.setEjecutivo(Ejecutivo);
                VIF.setEmpleado(Empleado);
                VIF.setProducto(Producto);
                VIF.setProveedor(Proveedor);
                VIF.setWebCam(this);
                VIF.setVisible(true);
            }    
        }
...
//      this.Dispositivos.dispose();
    ...
    public void GuardarImagen() throws IOException, BasicPlayerException{
...
//   String Path = Ruta+Pic;
  ...
  String Fecha = sdf.format(Date);
    ...
    File Flash = new File("");
    String MP3 = Flash.getAbsolutePath();
    MP3 = MP3.concat("/Flash.mp3");
