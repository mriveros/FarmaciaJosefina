...
public void Conectar(String url,String user,String pass)throws SQLException,ClassNotFoundException, IOException, MessagingException
{  
    
    try {
            // Get connection
            DriverManager.registerDriver( new com.microsoft.sqlserver.jdbc.SQLServerDriver() );
            con = DriverManager.getConnection("jdbc:sqlserver://localhost:1433; Server=PC;"
                    + "databaseName=SistemaFarmacia", user, pass);
